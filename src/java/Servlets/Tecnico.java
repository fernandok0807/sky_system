...
public class Tecnico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Tecnico</title>");            
            out.println("</head>");
            out.println("<body>");
            TecnicoClass nuevo = new TecnicoClass();
            ...
            int accion = Integer.parseInt(request.getParameter("actualizar"));
                if(accion == 1){
                    TecnicoClass nuevo2 = new TecnicoClass();
                    ...
                    System.out.println("respondiendo"+request.getParameter("txtsupervisor"));
                    
                    //nuevo2.setCod_supervisor(request.getParameter("txtsupervisor"));
                    if(request.getParameter("txtsupervisor")==null){
                        nuevo2.setCod_supervisor(request.getParameter("txtsuperviso"));
                    }
                    else{
                        nuevo2.setCod_supervisor(request.getParameter("txtsupervisor"));
                    }
